    ...
    string Name, int Hp, int Speed, int Capacity, int Tonnage, int Crew, int Guns, int Price)
{
    ...
    [
        new("갤리온",     70, 55, 375, 3500, 40, 24, 500),
        new("중카락",     60, 35, 400, 4000, 45, 24, 400),
        new("카락",       30, 60, 200, 1750, 20,  6, 300),
        new("대형카라벨", 35, 50, 250, 2000, 30,  8, 200),
        new("카라벨",     20, 80, 125, 1250, 15,  2, 100),
    ];
